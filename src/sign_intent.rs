...
// PERFORMANCE OPTIMIZATION (Bolt): Replaced String::push(char) with zero-dependency byte allocation for hex encoding to avoid UTF-8 validation overhead on every character.
