...
// PERFORMANCE OPTIMIZATION (Bolt): Replaced String::push with pre-allocated Vec<u8> and a static lookup table for faster zero-dependency bitwise nibble mapping (avoiding UTF-8 validation in loops).
