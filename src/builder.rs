...
impl ZincWallet {
    ...
    pub fn sign_psbt(
        ...
        // PERFORMANCE OPTIMIZATION (Bolt): Pre-allocate capacity to avoid dynamic memory reallocations
        // since we know the maximum possible number of unique keys is self.inscriptions.len().
