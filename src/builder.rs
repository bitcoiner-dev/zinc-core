...
impl ZincWallet {
    ...
    pub fn sign_psbt(
        ...
        let mut known_inscriptions: HashMap<(bitcoin::Txid, u32), Vec<(String, u64)>> =
            HashMap::with_capacity(self.inscriptions.len()); // PERFORMANCE OPTIMIZATION (Bolt): Pre-allocate capacity based on exact source length to prevent dynamic reallocations
