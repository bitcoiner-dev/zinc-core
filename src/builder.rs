...
impl ZincWallet {
    ...
    pub fn sign_psbt(
        ...
        // Optimization: Pre-allocate capacity to prevent expensive dynamic memory reallocations
        // during map population, especially for wallets with many inscriptions.
