...
## 2024-05-22 - Remove unwrap on derivation indices
**Vulnerability:** Unsafe unwrap on dynamic indices in child derivation path can panic.
**Learning:** Dynamic values used for bip32 derivation can panic on invalid indices.
**Prevention:** Return Result and properly handle index creation errors.
